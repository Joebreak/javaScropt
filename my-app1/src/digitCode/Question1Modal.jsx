...
const positionMapping = {
  ...
  'J': { digits: ['T', 'U', 'V'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // J: TUV的全部a-g段
  'K': { digits: ['T', 'U', 'V'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // K: TUV的全部a-g段
  'L': { digits: ['T', 'U', 'V'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // L: TUV的全部a-g段
  'M': { digits: ['T', 'U', 'V'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // M: TUV的全部a-g段
  'N': { digits: ['T', 'U', 'V'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // N: TUV的全部a-g段
  'O': { digits: ['W', 'X', 'Y'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // O: WXY的全部a-g段
  'P': { digits: ['W', 'X', 'Y'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // P: WXY的全部a-g段
  'Q': { digits: ['W', 'X', 'Y'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // Q: WXY的全部a-g段
  'R': { digits: ['W', 'X', 'Y'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] }, // R: WXY的全部a-g段
  'S': { digits: ['W', 'X', 'Y'], segments: ['a', 'b', 'c', 'd', 'e', 'f', 'g'] } // S: WXY的全部a-g段
};
...
export default function Question1Modal({ 
  ...
  // 當前選中的範圍
  const currentRange = positionRanges.find(r => r.positions.includes(selectedPosition)) || positionRanges[0];
